...
type Record struct {
	...
	// setPTR if true, and if the requested type is A, it is posible to autogenerate the PTR record.
	// Can be useful for private networks. Currently supports only IPv4 and uses only default TTL.
...
type DNSRecordStatus struct {
	...
	// autoIPv4PTR displays the autogenerated PTR record
	AutoIPv4PTR bool `json:"autoIPv4PTR,omitempty"`
